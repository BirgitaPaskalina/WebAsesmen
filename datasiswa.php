                      ...
                      <table class="table table-striped" id="tabelSiswa">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="edit_siswa.php?nisn=<?= htmlspecialchars($x['nisn']); ?>" class="btn-edit"><i class="bi bi-pencil-square"></i> Edit</a>
                              <a href="hapus_siswa.php?nisn=<?= htmlspecialchars($x['nisn']); ?>" class="btn-delete" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i> Hapus</a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
