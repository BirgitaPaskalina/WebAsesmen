...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <a href="tambahjurusan.php" class="btn btn-primary mt-3 mb-2"><i class="bi bi-person-plus"></i> Tambah Jurusan</a>
    <div class="row">
      <div class="col-md-12">
         <div class="card mb-4">
                      ...
                      <table class="table table-striped" id="tabelJurusan">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="edit_jurusan.php?kode_jurusan=<?= htmlspecialchars($x['kode_jurusan']); ?>" class="btn-edit"><i class="bi bi-pencil-square"></i> Edit</a>
                              <a href="hapus_jurusan.php?kode_jurusan=<?= htmlspecialchars($x['kode_jurusan']); ?>" class="btn-delete" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i> Hapus</a>
                            </td>
                          </tr>
                          <?php endforeach; ?>
                        </tbody>
