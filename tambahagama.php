...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $idagama = trim(string: $_POST['idagama']);
    $nama_agama = trim(string: $_POST['nama_agama']);
    $result = mysqli_query($db->koneksi, query: "INSERT INTO agama (idagama, nama_agama) VALUES ('$idagama', '$nama_agama')");
}
?>
<!doctype html>
<html lang="en">
  ...
  <body class="bg-body-tertiary">
    <div class="container">
      <div class="form-container">
        <h3 class="mb-3 text-primary"><i class="bi bi-plus-circle"></i> Tambah Agama</h3>
        <?= $pesan ?>
        <form method="post" autocomplete="off" class="needs-validation" novalidate>
          ...
          <div class="d-grid">
            <button class="btn btn-info" type="submit" name="simpan"><i class="bi bi-save"></i> Tambah Agama</button>
          </div>
